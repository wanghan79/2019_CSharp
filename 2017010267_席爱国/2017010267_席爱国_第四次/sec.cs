...
namespace sec
{
    public partial class filesearch : Form
    {
        ...
        public static void search_files_in_folder(object obj)
        {
            ...
            filesearch this_form = (filesearch)obj;
            //str_dir = thisForm.folder_path.Text;
            str_dir = this_form.file_string_dir;
        ...
        private void searching_time_Tick(object sender, EventArgs e)
        {
            int i = 100;
            searching.Value = searching.Value + 1;
            i = 100 - searching.Value;
            if (i == 0)
            {
                searching_time.Enabled = false;
            }
        }
