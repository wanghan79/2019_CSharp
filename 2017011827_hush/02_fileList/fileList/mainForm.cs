...
namespace fileList
{
    public partial class mainForm : Form
    {
        ...
        private void cbb_pickFormat_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            changeFiles(pickPath, format, false);
        }
        ...
        private void lab_pickPath_Click(object sender, EventArgs e)
        {
            ...
            if (saveDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                changeFiles(pickPath,"*",true);
            }
        }

        
        public void changeFiles(string changePath,string changeFormat,bool isResetFormat)
        {
            //清除listBox与comboBox
            ...
            //listBox显示文件
            string[] files = Directory.GetFiles(changePath, changeFormat, SearchOption.AllDirectories);
