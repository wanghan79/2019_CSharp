...
namespace Files.lib
{
    class File1
    {
        private delegate void reflush(object obj);
        ...
        public void searchFilesFolder(object obj)
        {
            ...
            //Files.listBoxFile listBox = new listBoxFile();
            string strDir = listBoxFile.fs.rootDirectory;
            ...
            if (strDir != null && strDir.Length > 0)
            {
                if (Directory.Exists(strDir))
                {
                    ...
                    reflush reflush = new reflush(list.bindText);
                    list.Invoke(reflush, list);
                    //Thread addfiles = new Thread(new ParameterizedThreadStart(list.bindText));
                    //addfiles.Start();
                }
            }
        }
